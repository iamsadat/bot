...
from jobhunt.s3_client import FakeS3Client, S3Client
...
class TestS3ClientInit:
    @patch("boto3.client")
    def test_init_with_default_params(self, mock_boto3_client):
        mock_s3 = MagicMock()
    ...
    @patch("boto3.client")
    def test_init_with_custom_region_and_endpoint(self, mock_boto3_client):
        mock_s3 = MagicMock()
        mock_boto3_client.return_value = mock_s3
    ...
    @patch("boto3.client")
    def test_init_with_credentials(self, mock_boto3_client):
        mock_s3 = MagicMock()
        mock_boto3_client.return_value = mock_s3
...
class TestS3ClientMethods:
    @patch("boto3.client")
    def test_upload_file_aws_url(self, mock_boto3_client):
        mock_s3 = MagicMock()
    ...
    @patch("boto3.client")
    def test_upload_file_custom_endpoint_url(self, mock_boto3_client):
        mock_s3 = MagicMock()
    ...
    @patch("boto3.client")
    def test_list_files_with_contents(self, mock_boto3_client):
        mock_s3 = MagicMock()
